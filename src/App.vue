    ...
    <div class="grow relative flex flex-col overflow-auto bg-gray-100">
      ...
      <div class="flex h-full bg-gray-100 border-t border-gray-200">
        ...
        >
          <div>
            <a
              class="text-gray-700 font-medium flex items-center h-9 pl-3 space-x-2 rounded-lg"
              href="/explore/apps"
              style=""
              ><svg
                width="16"
              ...
              <div class="text-sm">灵感渲染</div></a
            ><a
              class="text-primary-600 bg-white font-semibold flex items-center h-9 pl-3 space-x-2 rounded-lg"
              href="/explore/chat"
